...
const NewsSection = () => {
    ...
    return (
        <div className="p-8 bg-black">
            <h1 className="text-4xl mb-8 text-center text-green-700 uppercase tracking-wide relative animate-bubbleUp">
                ...
                {newsItems.map((news, index) => (
                    <div key={index} className="bg-black border-2 border-gray-600 rounded-lg p-4 w-1/3 h-96 shadow-lg transform transition-transform duration-300 hover:translate-y-2 hover:shadow-2xl flex flex-col overflow-hidden">
                        ...
                        <div className="flex flex-col justify-between flex-grow p-4">
                            <h2 className="text-2xl mb-2 text-green-700 transition-colors duration-300 hover:text-blue-400">{news.title}</h2>
